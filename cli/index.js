...
const run = async () => {
    ...
    console.log(
        chalk.green(
        figlet.textSync('SLP Post Office', { horizontalLayout: 'fitted' })
        )
    );
    ...
    fs.writeFile('config.json', JSON.stringify(configObj), err => err ? console.error(err) : console.log('Post Office fully configured'));
  };
